 ...
 * @author Praise
 */
public class CompanyStocksFilter implements Filter
{
    ...
    {
        if(debug)
            log("CompanyStocksFilter:DoBeforeProcessing");
    ...
    {
        if(debug)
            log("CompanyStocksFilter:DoAfterProcessing");
    ...
    {
        if(debug)
            log("CompanyStocksFilter:doFilter()");
        ...
        try
        {
            ...
            wrappedRequest.setAttribute("companyStocks", companyStocks);
    ...
    public void init(FilterConfig filterConfig)
    {
        ...
        if(filterConfig != null)
            if(debug)
                log("CompanyStocksFilter: Initializing filter");
    }
    ...
    {
        if(filterConfig == null)
            return ("CompanyStocksFilter()");
        StringBuffer sb = new StringBuffer("CompanyStocksFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper
    {
        ...
        {
            if(debug)
                System.out.println("CompanyStocksFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
        ...
        {
            if(debug)
                System.out.println("CompanyStocksFilter::getParameter(" + name + ") localParams = " + localParams);
            if(localParams == null)
        ...
        {
            if(debug)
                System.out.println("CompanyStocksFilter::getParameterValues(" + name + ") localParams = " + localParams);
            if(localParams == null)
        ...
        {
            if(debug)
                System.out.println("CompanyStocksFilter::getParameterNames() localParams = " + localParams);
            if(localParams == null)
        ...
        {
            if(debug)
                System.out.println("CompanyStocksFilter::getParameterMap() localParams = " + localParams);
            if(localParams == null)
