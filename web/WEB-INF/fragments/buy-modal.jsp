        ...
        <div class="modal-content">
            ...
            <form id="buy-transaction">
                ...
                <div class="modal-body">
                    ...
                    <input id="companyName" value="companyName" hidden=""/>
                    <input id="username" value="username" hidden=""/>
                    <input id="symbol" value="symbol" hidden=""/>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" type="submit" data-toggle="modal" data-target="#payment-modal-form">Pay Now</button>
                </div>
            </form>
        </div>
    </div>
